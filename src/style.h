...
bool style_buttonWithHighlight(bool selected, const char* name) {
    bool out = false;
    HMM_Vec2 size = snzr_strSize(&style_labelFont, name, strlen(name));
    ...
    snzu_boxScope() {
        ...
        snzu_boxSetDisplayStr(&style_labelFont, STYLE_TEXT_COLOR, name);
